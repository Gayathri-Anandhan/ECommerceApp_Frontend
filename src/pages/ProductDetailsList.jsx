    ...
    return (
        <div className="bg-[#F5F1E8] min-h-screen p-10">
            {/* <div className="bg-[#F5F1E8] p-15 rounded-3xl text-neutral-800 shadow-sm mb-10 border border-neutral-200"> */}
                ...
                <button className="items-center bg-[#F5F1E8] text-gray px-4 py-2 rounded-lg hover:bg-[#F5F1E8]-800 transition float-end" onClick={() => navigate("/ProductDetails")}><PlusIcon className="w-6 h-6"></PlusIcon>Add New Product</button><br></br>
                <br></br><br></br>
                <div className="bg-white p-10 rounded-3xl text-neutral-800 shadow-sm mb-10 border border-neutral-200">
                    <div className="row mb-3">
                        ...
                        <div className="flex m-4 col-md-2 gap-4">
                            ...
                            <button
                                className="items-center bg-[#F5F1E8] text-gray px-4 py-2 rounded-lg hover:bg-[#F5F1E8]-800 transition"
